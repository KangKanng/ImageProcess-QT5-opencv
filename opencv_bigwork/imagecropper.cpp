...
void ImageCropperDemo::setupLayout() {
    ...
    formLayout1->addRow(new QLabel("源图像:", this), hOriginalImagePathLayout);
    formLayout1->addRow(new QLabel("输出图片形状:", this), comboOutputShape);
    formLayout1->addRow(new QLabel("裁剪框形状:", this), comboCropperShape);
    formLayout1->addRow(new QLabel("固定尺寸:", this), hCropperFixedSizeLayout);
    formLayout1->addRow(new QLabel("最小尺寸:", this), hCropperMinSizeLayout);

    QFormLayout* formLayout2 = new QFormLayout();
    formLayout2->addRow(new QLabel("是否透明:", this), checkEnableOpacity);
    formLayout2->addRow(new QLabel("透明度:", this), sliderOpacity);

    QFormLayout* formLayout3 = new QFormLayout();
    formLayout3->addRow(new QLabel("是否显示拖拽方块:", this), checkShowDragSquare);
    formLayout3->addRow(new QLabel("拖拽方块尺寸:", this), editDragSquareEdge);
    formLayout3->addRow(new QLabel("拖拽方块颜色:", this), hDragSquareColorLayout);

    QFormLayout* formLayout4 = new QFormLayout();
    formLayout4->addRow(new QLabel("是否显示裁剪框:", this), checkShowRectBorder);
    formLayout4->addRow(new QLabel("裁剪框颜色:", this), hRectBorderColorLayout);
